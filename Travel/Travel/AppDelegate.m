...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //设置友盟的appKey
    [UMSocialData setAppKey:@"53f5a6a6fd98c50d6b0029d3"];
    ...
    manage.toolbarTintColor = [UIColor redColor];
    manage.enableAutoToolbar = YES;
    manage.toolbarManageBehaviour = UIReturnKeyDone;
